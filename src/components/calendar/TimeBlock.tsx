import { TimeObject, TaskType, TYPE_ICONS, TASK_TYPE_LABELS } from '@/types/calendar';
import { useCalendarStore } from '@/store/calendarStore';
import { motion } from 'framer-motion';
import { Check, Clock, GripVertical, Trash2, AlertTriangle } from 'lucide-react';
...
export function TimeBlock({ task, pixelsPerMinute }: TimeBlockProps) {
  ...
  return (
    <motion.div
      ...
      style={{ top, height }}
      className={`absolute left-16 right-2 rounded-lg px-3 py-1.5 ${categoryClass} cursor-pointer group transition-all hover:brightness-110 ${
